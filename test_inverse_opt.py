...
def test1(delaytype, noisy, noise=0.0):
    ...
    g1, g2, g3, g4, l1, l2, l3, l4 = get_graphs_linkflows(true_theta, delaytype)
    z1, z2, z3, z4 = l1, l2, l3, l4
    if noisy:
        l1, l2, l3, l4 = add_noise(l1,noise), add_noise(l2,noise), add_noise(l3,noise), add_noise(l4,noise)
        g1, g2, g3, g4 = los_angeles(coef, 'Polynomial', True, noise)
    min_error = np.inf
    for i in [1e-2, 1e0, 1e2, 1e4, 1e6]:
        theta = invopt.solver([g1, g2, g3, g4], [l1, l2, l3, l4], degree, i*np.ones(degree))
        g1, g2, g3, g4, x1, x2, x3, x4 = get_graphs_linkflows(theta,  'Polynomial', True, noise)
    ...
    display_results([l1, l2, l3, l4], [y1, y2, y3, y4], true_theta, best_theta, delaytype, best_smooth)
...
def test3(indlinks_obs, noisy, delaytype, noise=0.0):
    ...
    theta, xs, beta = invopt.main_solver([g1,g2,g3,g4], [l1[obs],l2[obs],l3[obs],l4[obs]], obs, degree, [1e-2,1e0,1e2,1e4,1e6])
    display_results([l1,l2,l3,l4], xs, true_theta, theta, delaytype, betas)
    
    
def test4(indlinks_obs, faulty, noisy=False):
...
def main():
    ...
    ind_obs[1] = [(17,24,1), (24,40,1), (14,21,1), (16,23,1)]
    ind_obs[2] = [(10,9,1), (19,18,1), (4,5,1), (29,21,1)]
    noise = 1/15.0
    test1(type, True, noise)
    for k in range(len(ind_obs)): test3(ind_obs[k], True, type, noise)
