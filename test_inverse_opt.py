...
def test4():
    ...
    and x generated by each candidate function
...
def test7(indlinks_obs, max_iter):
    """2-fold test to find smooth that minimizes the distance between x^obs_true (exact)
