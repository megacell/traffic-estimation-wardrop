...
def test4(indlinks_obs):
    """find parameters that minimizes the distance between x^obs_true EXACT
    ...
    for i in [10.0, 100.0, 1000.0, 10000.0]:
        ...
        if e < min_error:
            best_param, min_error, best_theta = i, e, theta
...
def main():
    ...
    #indlinks_obs = [(17,24,1), (36,37,1), (12,13,1), (13,14,1), (17,8,1), (24,17,1), (28,22,1), (14,13,1), (17,24,1), (24,40,1), (14,21,1), (16,23,1)]
    indlinks_obs = [(17,24,1), (24,40,1), (14,21,1), (16,23,1)]
