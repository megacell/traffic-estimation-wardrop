...
def experiment(indlinks_obs, delaytype, noise=0.0, display=False, soft=1000.0):
    ...
    theta, xs, beta = invopt.main_solver([g1,g2,g3,g4], [x1[obs],x2[obs],x3[obs],x4[obs]], obs, degree, soft)
...
def test1(type, noise):
    ...
    for k in range(len(ind_obs)): experiment(ind_obs[k], type, noise, True)
